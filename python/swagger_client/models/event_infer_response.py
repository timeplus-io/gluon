...
class EventInferResponse(object):
    ...
    def inferred_columns(self, inferred_columns):
        ...
        if inferred_columns is None:
            raise ValueError("Invalid value for `inferred_columns`, must not be `None`")  # noqa: E501
    ...
    def recommeneded_columns(self, recommeneded_columns):
        ...
        :type: list[ColumnDef]
        """
        if recommeneded_columns is None:
            raise ValueError("Invalid value for `recommeneded_columns`, must not be `None`")  # noqa: E501
