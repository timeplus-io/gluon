...
class QueriesV1beta2Api(object):
    ...
    def v1beta2_queries_exec_post(self, body, **kwargs):  # noqa: E501
        """execute a DDL query  # noqa: E501

        Execute a DDL query. Currently only create external stream is supported.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1beta2_queries_exec_post(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ExecuteQueryRequest body: query request parameters (required)
        :return: Query
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.v1beta2_queries_exec_post_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.v1beta2_queries_exec_post_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def v1beta2_queries_exec_post_with_http_info(self, body, **kwargs):  # noqa: E501
        """execute a DDL query  # noqa: E501

        Execute a DDL query. Currently only create external stream is supported.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1beta2_queries_exec_post_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1beta2_queries_exec_post" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `v1beta2_queries_exec_post`")  # noqa: E501
