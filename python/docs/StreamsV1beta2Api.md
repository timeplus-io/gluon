...
[**v1beta2_streamsname_get**](StreamsV1beta2Api.md#v1beta2_streamsname_get) | **GET** /v1beta2/streams/:name | get a stream.
[**v1beta2_streamsname_stats_get**](StreamsV1beta2Api.md#v1beta2_streamsname_stats_get) | **GET** /v1beta2/streams/:name/stats | get the stats of a stream.
...
> StreamDef v1beta2_streams_post(body)
...
# **v1beta2_streamsname_get**
> Stream v1beta2_streamsname_get(name)
...
try:
    # get a stream.
    api_response = api_instance.v1beta2_streamsname_get(name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling StreamsV1beta2Api->v1beta2_streamsname_get: %s\n" % e)
```
...
# **v1beta2_streamsname_stats_get**
> StreamStats v1beta2_streamsname_stats_get(name)
...
try:
    # get the stats of a stream.
    api_response = api_instance.v1beta2_streamsname_stats_get(name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling StreamsV1beta2Api->v1beta2_streamsname_stats_get: %s\n" % e)
```
