...
[**v1beta2_viewsname_get**](ViewsV1beta2Api.md#v1beta2_viewsname_get) | **GET** /v1beta2/views/:name | get a view.
[**v1beta2_viewsname_stats_get**](ViewsV1beta2Api.md#v1beta2_viewsname_stats_get) | **GET** /v1beta2/views/:name/stats | get the stats of a view.
...
# **v1beta2_viewsname_get**
> View v1beta2_viewsname_get(name)
...
try:
    # get a view.
    api_response = api_instance.v1beta2_viewsname_get(name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ViewsV1beta2Api->v1beta2_viewsname_get: %s\n" % e)
```
...
# **v1beta2_viewsname_stats_get**
> StreamStats v1beta2_viewsname_stats_get(name)
...
try:
    # get the stats of a view.
    api_response = api_instance.v1beta2_viewsname_stats_get(name)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling ViewsV1beta2Api->v1beta2_viewsname_stats_get: %s\n" % e)
```
