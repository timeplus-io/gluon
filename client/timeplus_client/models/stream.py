...
class Stream(object):
    ...
    def __init__(self, columns=None, created_at=None, created_by=None, engine=None, is_external=None, last_updated_at=None, last_updated_by=None, logstore_retention_bytes=None, logstore_retention_ms=None, name=None, stats=None, ttl=None):  # noqa: E501
