...
class View(object):
    ...
    def __init__(self, columns=None, created_at=None, created_by=None, last_updated_at=None, last_updated_by=None, materialized=None, name=None, query=None):  # noqa: E501
