...
class SinksV1beta1Api(object):
    ...
    def v1beta1_sinks_get_with_http_info(self, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type="list[SinkWithMetrics]",  # noqa: E501
    ...
    def v1beta1_sinks_id_delete(self, id, **kwargs):  # noqa: E501
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.v1beta1_sinks_id_delete_with_http_info(
                id, **kwargs
            )  # noqa: E501
        else:
            (data) = self.v1beta1_sinks_id_delete_with_http_info(
                id, **kwargs
            )  # noqa: E501
            return data
    ...
    def v1beta1_sinks_id_delete_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if "id" not in params or params["id"] is None:
            raise ValueError(
                "Missing the required parameter `id` when calling `v1beta1_sinks_id_delete`"
            )  # noqa: E501
    ...
    def v1beta1_sinks_id_get(self, id, **kwargs):  # noqa: E501
        ...
        if kwargs.get("async_req"):
            ...
            (data) = self.v1beta1_sinks_id_get_with_http_info(
                id, **kwargs
            )  # noqa: E501
            return data
    ...
    def v1beta1_sinks_id_get_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        if "id" not in params or params["id"] is None:
            raise ValueError(
                "Missing the required parameter `id` when calling `v1beta1_sinks_id_get`"
            )  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type="SinkWithMetrics",  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get("async_req"),
            _return_http_data_only=params.get("_return_http_data_only"),
            _preload_content=params.get("_preload_content", True),
    ...
    def v1beta1_sinks_post(self, body, **kwargs):  # noqa: E501
        ...
        if kwargs.get("async_req"):
            ...
            (data) = self.v1beta1_sinks_post_with_http_info(
                body, **kwargs
            )  # noqa: E501
            return data
    ...
    def v1beta1_sinks_post_with_http_info(self, body, **kwargs):  # noqa: E501
        ...
        if "body" not in params or params["body"] is None:
            raise ValueError(
                "Missing the required parameter `body` when calling `v1beta1_sinks_post`"
            )  # noqa: E501
